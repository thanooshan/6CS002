...
//    System.out.println("Serial number " + Special.getStamp());
    ...
    while (_$_ != ZERO) {
      ...
      switch (_$_) {
      case 5:
        int index = (int) (Math.random() * (Portishead.wildcat.length / 3));
        String what = Portishead.wildcat[index * 3];
        String who = Portishead.wildcat[1 + index * 3];
      ...
      case 3: {
        ...
        JFrame f = new JFrame("Rules by Amjad Mohammed");
